...
plotdata$Group <- factor(plotdata$Group,levels = c("A","B","C","D","E","F","G","H"),
                         labels = c("<50g","50-100g","100-150g","150-200g",
                                    "200-250g","250-300g","300-350g",">350g"))
...
p2<-ggplot(plotdata, aes(PC1, PC2)) +
  ...
  scale_fill_manual(values=cbbPalette,name = "Body weight")+
  ...
  theme(panel.background = element_rect(fill='white', colour='black'),
        ...
        axis.line = element_line(colour = "black"), 
        axis.title.x=element_text(colour='black', size=34,vjust = 5),
        axis.title.y=element_text(colour='black', size=34,vjust = -1),
